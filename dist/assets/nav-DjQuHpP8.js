var e=[{id:`foundations`,label:`기부하기`,href:`./foundations.html`},{id:`status`,label:`내 기부 현황`,href:`./status.html`},{id:`about`,label:`서비스 소개`,href:`./about.html`},{id:`admin`,label:`Admin`,href:`./admin.html`}];function t(t){return`
