import"./styles-BzChqKUB.js";import{t as e}from"./provider-BW_KG98z.js";import{t}from"./nav-CMc74gyL.js";import{i as n,n as r}from"./wallet-Dhb9Radt.js";import{t as i}from"./donations-lDV30RJe.js";var a=document.getElementById(`top-nav`);a&&(a.innerHTML=t(`status`));var o=document.getElementById(`status-summary`),s=document.getElementById(`status-timeline`),c=document.getElementById(`status-table`),l=`usr_demo_001`;function u(e){return`${new Intl.NumberFormat(`ko-KR`).format(e)}원`}function d(e){return new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`}).format(new Date(e))}function f(e){return{paid:`결제 완료`,pending:`결제 대기`,failed:`결제 실패`,recorded:`증빙 기록 완료`,minted:`Proof NFT 발행 완료`,scheduled:`정산 예정`,done:`정산 완료`,error:`오류`}[e]??e}async function p(){let t=await e(),a=await t.userRepository.getProfile(l),p=await t.userRepository.getDonationStatus(l),m=await t.donationRepository.listDonationsByUser(l),h=r(),g=[];h&&(g=(await n(h.account)).map(e=>({id:e.id,userId:e.userId,donatedAt:e.donatedAt,amountKrw:e.amountKrw,allocations:e.allocations,paymentStatus:e.paymentStatus,proofStatus:e.proofStatus,nftStatus:e.nftStatus,settlementStatus:e.settlementStatus,txHash:e.txHash??void 0,proofNftId:e.proofNftId??void 0,explorerUrl:e.explorerUrl??void 0,validationStatus:e.validationStatus,source:`local`,dbId:e.id})));let _=i(m,l),v=new Set(g.map(e=>e.id)),y=[...g,..._.filter(e=>!v.has(e.dbId??``)&&!v.has(e.id))].sort((e,t)=>e.donatedAt<t.donatedAt?1:-1);if(!a||!p){o&&(o.innerHTML=`<div class="notice error">사용자 상태를 불러오지 못했습니다.</div>`);return}let b=y.reduce((e,t)=>e+t.amountKrw,0);o&&(o.innerHTML=`
