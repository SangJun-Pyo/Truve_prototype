  ...
  return `
    <article class="foundation-list-card card foundation-hub-card">
      ...
      <div class="foundation-list-side">
        ...
        <a class="primary-link-button" href="./foundation-detail.html?id=${encodeURIComponent(foundation.id)}">상세 보기</a>
      </div>
    </article>
  `;
}
...
function render(): void {
  ...
  if (countEl) {
    countEl.textContent = `${filtered.length.toLocaleString("ko-KR")}곳`;
  }
