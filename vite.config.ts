  ...
  build: {
    rollupOptions: {
      input: {
        ...
        campaignChadWater: resolve(__dirname, "campaign-chad-water.html"),
        campaignEthiopiaSchool: resolve(__dirname, "campaign-ethiopia-school.html"),
        campaignRwandaSchool: resolve(__dirname, "campaign-rwanda-school.html"),
        campaignMalawiWater: resolve(__dirname, "campaign-malawi-water.html"),
